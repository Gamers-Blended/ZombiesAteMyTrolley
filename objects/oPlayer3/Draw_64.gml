...
if (shouldShowInventory) {
	...
	for (var i = 0; i < len; i++) {
		...
		draw_sprite(object_get_sprite(key), 0,oShoppingList3.x+32,oShoppingList3.y+256+30*i+10);
		//draw_text(32,64+ 20*i, ": " + string(value));
		draw_text_transformed(oShoppingList3.x+64,oShoppingList3.y+256+30*i,": "+string(value), 1.5, 1.5,0);
	}
}
